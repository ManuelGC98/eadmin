...
public class DocumentoRegistro extends Documento {
	...
	public DocumentoRegistro(Integer codigo, String nombre, Date fechaCreacion, Date fechaUltimaActualizacion,
			Boolean publico, EstadoDocumento estado, String dniInteresado, String codigoRegistro) {
